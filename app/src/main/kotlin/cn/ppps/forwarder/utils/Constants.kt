...
//注意：TASK_CONDITION_XXX 枚举值 等于 TASK_CONDITION_FRAGMENT_LIST 索引加上 KEY_BACK_CODE_CONDITION
const val TASK_CONDITION_CRON = 1000
const val TASK_CONDITION_SIM = 1001
const val TASK_CONDITION_SMS = 1002
const val TASK_CONDITION_CALL = 1003

//注意：TASK_ACTION_XXX 枚举值 等于 TASK_ACTION_FRAGMENT_LIST 索引加上 KEY_BACK_CODE_ACTION
const val TASK_ACTION_SENDSMS = 2000
const val TASK_ACTION_CLEANER = 2001
const val TASK_ACTION_RULE = 2002
const val TASK_ACTION_SENDER = 2003
const val TASK_ACTION_ALARM = 2004
const val TASK_ACTION_RESEND = 2005
const val TASK_ACTION_TASK = 2006
const val TASK_ACTION_NOTIFICATION = 2007
